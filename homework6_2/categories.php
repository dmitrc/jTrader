<html>
<head>
	<title>jTrade Categories Insert Form</title>
...
<form action="inc/categories.php" method="post">
Category ID:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="id"><br>
Category Type:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="type"><br>
Category Subtype: <input type="text" name="subtype"><br>
Description:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="description"><br>
<input type="submit">
</form>
