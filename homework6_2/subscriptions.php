...
Subscription ID:<input type="text" name="id"><br>
User ID:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="userid"><br>
Category ID: &nbsp&nbsp&nbsp<input type="text" name="catid"><br>
<input type="submit">
</form>
